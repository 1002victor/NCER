# Generated by Django 2.1.7 on 2019-04-01 18:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Level', models.CharField(choices=[('一级', (('14', '计算机基础及WPS Office应用'), ('15', '计算机基础及MS Office应用'), ('16', '计算机基础及Photoshop应用'), ('17', '网络安全素质教育'))), ('二级', (('24', 'C语言程序设计'), ('26', 'VB语言程序设计'), ('28', 'Java语言程序设计'), ('29', 'Access数据库程序设计'), ('61', 'C++语言程序设计'), ('63', 'MySQL数据库程序设计'), ('64', 'Web程序设计'), ('65', 'MS Office高级应用'), ('66', 'Python语言程序设计'))), ('三级', (('45', '计网络技术'), ('36', '数据库技术'), ('38', '信息安全技术'), ('39', '嵌入式系统开发技术'))), ('四级', (('41', '网络工程师'), ('42', '数据库工程师'), ('44', '信息安全工程师'), ('45', '嵌入式系统开发工程师')))], max_length=2, verbose_name='考试分类')),
        ...
        migrations.AddField(
            ...
            name='Tags',
            field=models.ManyToManyField(to='NCER.Tag'),
        ),
        migrations.AddField(
            model_name='choicequestions',
            name='Type',
